...
public record WebMapStorage(HashMap<String, HashMap<String, Point>> points, HashMap<String, String> sets, SubwaySystem subwaySystem)
{
    ...
    public WebMapStorage(){this(new HashMap<>(),new HashMap<>(),new SubwaySystem());}
}
